...
const sortButton=document.querySelector('#start')! as HTMLButtonElement
const howmanyInput=document.querySelector('#Howmany')! as HTMLInputElement
const canvas=document.querySelector('canvas')!as HTMLCanvasElement
const algoSelector=document.querySelector('#algorithm')! as HTMLSelectElement
const pauseButton=document.querySelector('#pause')! as HTMLButtonElement
const showArray=document.querySelector('#showArray')! as HTMLButtonElement
const arrayTextBox=document.querySelector("#arrayText")!as HTMLTextAreaElement
const arrayDisplay=document.querySelector("#array")! as HTMLDivElement
...
function* selection(arr:number[]):any{
...
function* merge(arr:number[],start:number, mid:number, end:number):any{
...
function* mergeSort(arr:number[],start:number=0,end:number=arr.length):any{
    if(start<end-1){
...
function* bubbleSort(arr:number[]):any{
...
let shouldSort:boolean|undefined=undefined


let start:any=undefined,end:any=undefined//to know the area we are operation on
const render=()=>{
